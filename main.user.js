...
// @version      0.1.9
// @description  shellshockers aimbot and esp, but i removed the annoying ass ads (fuck you Zertalious)
// @author       beanfrog
// @match        *://shellshock.io/*
// @match        *://algebra.best/*
// @match        *://algebra.vip/*
...
// @antifeature  enormous cock
// ==/UserScript==

//the script throws a couple of errors around the 'shouldShowAd' variable, ignore them itll work fine
...
` + '<div class="popup_window popup_lg centered roundme_lg info" style="z-index: 9999999;">' +
    ...
    <h3 class="roundme_sm">Fuck Zertalious... all my homies hate Zertalious</h3>
    <h3 class="roundme_sm">Cheat unpatched as of 4 Feb 2023</h3>
	<h4 style="text-align:center;">
		...
		<br>
		<br>
		liberated by beanfrog
	</h4>
	<div id="btn-horizontal" class="f-center">
		<button class="ss_button btn_red bevel_red btn_sm" onclick="window.open('https://gkieran.github.io', '_blank')">Website</button>
		<button class="ss_button btn_yolk bevel_yolk btn_sm" onclick="window.open('https://gkieran.github.io/projects', '_blank')">More scripts</button>
	</div>
	<div id="btn-horizontal" class="f-center">
		<button class="ss_button btn_green bevel_green btn_sm" onclick="window.open('https://www.instagram.com/beanfrog_/', '_blank')">Instagram</button>
		<button class="ss_button btn_blue bevel_blue btn_sm" onclick="window.open('https://github.com/bean-frog', '_blank')">Github</button>
	</div>` ) +
'</div>';
